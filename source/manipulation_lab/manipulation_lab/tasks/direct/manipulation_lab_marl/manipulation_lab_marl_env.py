...
from .manipulation_lab_marl_env_cfg import ManipulationLabMarlEnvCfg


class ManipulationLabMarlEnv(DirectMARLEnv):
    cfg: ManipulationLabMarlEnvCfg

    def __init__(self, cfg: ManipulationLabMarlEnvCfg, render_mode: str | None = None, **kwargs):
