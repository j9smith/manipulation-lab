...
class OpenLoopHandler:
    def __init__(self, cfg):
        self.cfg = cfg
        self.reader = reader.DatasetReader(dataset_dir=self.cfg.openloop.dataset_dir)
    ...
    def run_open_loop(self):
        ...
        ee_actions = self.episode["actions"]["ee_deltas"]
        gripper_actions = self.episode["actions"]["gripper_deltas"]
